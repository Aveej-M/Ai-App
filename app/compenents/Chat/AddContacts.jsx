...
const AddContacts = ({openAddContacts, setOpenAddContacts}) => {
  ...
  return (
    <div className={`min-w-[40%] bg-white h-full overflow-y-auto transform transition-transform duration-300 pb-10 ${openAddContacts ? "translate-x-0" : "translate-x-full"}`}>
        ...
        {openContactForm && (
            <div className={`flex-items flex-col mt-1 transform transition-transform duration-300 ${openAddContacts ? "popup-in translate-x-0 opacity-100 delay-200 px-3" : "-translate-x-full opacity-0"}`}>
